        ...
        <div>
            <div class="row justify-content-between" style="margin-bottom: 10px;">
                ...
                <div class="col-md-2" style="margin-right: 15px;">
                    <button class="btn btn-primary" data-bs-toggle="modal" onclick="tambahMahasiswa()">
            ...
            <div class="col-lg-11">
                <table style="width: 100%; border-collapse: collapse; border: 1px solid #828282; text-align:center">
                    <tr style="padding: 8px; background-color:blue; color:white;">
                        ...
                        <th style="border: 1px solid #828282;">Tahun Angkatan</th>
                    ...
                    <tr>
                        ...
                        <td style="border: 1px solid #828282; padding: 8px;">{{ $mahasiswa->nim }}</td>
                        <td style="border: 1px solid #828282; padding: 8px;">{{ $mahasiswa->nama_lengkap }}</td>
                        <td style="border: 1px solid #828282; padding: 8px;">{{ $mahasiswa->program_studi }}</td>
                        <td style="border: 1px solid #828282; padding: 8px;">{{ $mahasiswa->tahun_angkatan }}</td>
                        <td style="border: 1px solid #828282; padding: 8px;">{{ $mahasiswa->email }}</td>
                        <td style="border: 1px solid #828282; padding: 8px;">{{ $mahasiswa->password }}</td>
                        <td style="padding: 8px; border: 1px solid #828282; padding: 8px;">
                            <!-- Tambahkan ID pada tombol edit -->
                            <button class="btn btn-sm edit-btn" style="background-color:yellow;" data-bs-toggle="modal" onclick="editMahasiswa('{{ $mahasiswa->nim }}')">
                                <i class="fas fa-edit"></i>
                            </button>
                            <form class="d-inline" id="deleteForm-{{ $mahasiswa->nim }}" action="{{ url('mahasiswa/'. $mahasiswa->nim) }}" method="post">
                                @csrf
                                @method('DELETE')
                                <button type="button" class="btn btn-sm" style="background-color:red;" onclick="confirmDelete('{{ $mahasiswa->nim }}')">
